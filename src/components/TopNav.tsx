        ...
        <div className="flex items-center gap-3">
          ...
          <div className="hidden md:flex items-center gap-2.5">
            <a href="https://www.instagram.com/due.college" target="_blank" rel="noopener noreferrer"
              className="text-[#aeaeb2] hover:text-[#1d1d1f] transition-colors" aria-label="Instagram">
            ...
            <a href="https://www.tiktok.com/@due.college" target="_blank" rel="noopener noreferrer"
              className="text-[#aeaeb2] hover:text-[#1d1d1f] transition-colors" aria-label="TikTok">
              <svg className="w-[16px] h-[16px]" viewBox="0 0 24 24" fill="currentColor">
            ...
            <a href="https://www.youtube.com/@due.college" target="_blank" rel="noopener noreferrer"
              className="text-[#aeaeb2] hover:text-[#1d1d1f] transition-colors" aria-label="YouTube">
              <svg className="w-[16px] h-[16px]" viewBox="0 0 24 24" fill="currentColor">
