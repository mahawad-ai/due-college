...
export default function MobileNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 z-40 md:hidden safe-area-pb">
      <div className="flex items-center justify-around h-16 max-w-container mx-auto px-4">
        {navItems.map((item) => {
          ...
          return (
            <Link
              ...
              href={item.href}
              className={cn(
                'flex flex-col items-center gap-1 py-2 px-4 rounded-xl transition-colors min-h-[44px] justify-center',
